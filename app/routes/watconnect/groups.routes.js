...
const groupsModal = require("../../models/watconnect/groups.model.js");
...
module.exports = app => {
    ...
    // .....................................Get All Groups........................................
    router.get("/:?", fetchUser, checkModuleAccess("groups"), async (req, res) => {
    ...
    router.post("/", fetchUser, checkModuleAccess("groups"), [body('name', 'Please enter Group Name').isLength({ min: 1 }),], async (req, res) => {
    ...
    //......................................Get group by Id.................................
    router.get("/:id", fetchUser, checkModuleAccess("groups"), async (req, res) => {
    ...
    router.delete('/member/:member_id', fetchUser, checkModuleAccess("groups"), async (req, res) => {
    ...
    router.post('/add_members/:groupId', fetchUser, checkModuleAccess("groups"), async (req, res) => {
    ...
    router.put('/:group_id/status', fetchUser, checkModuleAccess("groups"), async (req, res) => {
