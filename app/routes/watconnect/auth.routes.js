...
// const File = require("../../models/watconnect/file.model.js");
...
//     ],
//     async (req, res) => {
//       console.log("skjhdgvfshjsakdhfskjdfhdjskdfhskjhdgvfshjsakdhfskjdfhdjskdfhskjhdgvfshjsakdhfskjdfhdjskdfhskjhdgvfshjsakdhfskjdfhdjskdfh");
//       // #swagger.tags = ['Users']
...
//         // console.log("auth->>", req.userInfo);

//         const res = await Auth.findPublicEmail(email);
...
//     console.log("working prifiififii");
//     try {
...
//           const filePath = `${process.env.FILE_UPLOAD_PATHH}/${req.userinfo.tenantcode}/users/${parentId}`;
...
//       console.log("pdfreferencepdfreference", pdfreference);
//       if (pdfreference) {
...
//             req.userinfo.id
//           );
//           const uploadPath = `${process.env.FILE_UPLOAD_PATHH}/${req.userinfo.tenantcode}/users`;
