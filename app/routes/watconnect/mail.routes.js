...
const Company = require("../../models/watconnect/campaign.model.js");
...
module.exports = (app) => {
  ...
  router.post("/invoice/", fetchUser, async (req, res) => {
    console.log("working invoice routes");
    ...
    if (companyResult[0]?.adminemail) {
      const result = await Mailer.sendEmail(to, data, subject, "pending_invoice", body, pdfPath);
