...
const resMessageModel = require("../../models/watconnect/responsemessage.model.js");
...
module.exports = app => {
    ...
    // Get All Records
    router.get("/", fetchUser, checkModuleAccess("response_message"), async (req, res) => {
    ...
    // records create
    router.post("/", fetchUser, checkModuleAccess("response_message"), async (req, res) => {
    ...
    router.put("/:id", fetchUser, checkModuleAccess("response_message"), async (req, res) => {
    ...
    // delete record
    router.delete("/:id", fetchUser, checkModuleAccess("response_message"), async (req, res) => {
